...
- [[I/O Hardware - Port-Mapped vs Memory-Mapped I/O]] — Hardware register access.
- [[Direct Memory Access - DMA]] — Offloading bulk packet streaming.
- [[Disk Scheduling Algorithms - SSTF, SCAN, C-SCAN]] — I/O request queues.
- [[Zero-Copy I/O - sendfile, splice, io_uring]] — Ring buffer asynchronous polling (`io_uring_enter`).
